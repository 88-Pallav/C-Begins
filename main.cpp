...
int main() {            // main function (Executin begins here)
    ...
    // declaring the type and name of the variable 
...
Note: Exception handling can help deal with runtime errors.  

*Logic errors: *Errors or bugs that cause your program to run incorrectly, mistakes made by programmers. Eg.
